-- Migration: Fix missing is_superuser claim in JWT
-- The previous migration (20260131120000) accidentally removed the is_superuser claim
-- when adding workspace_name. This restores it.
